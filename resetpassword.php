                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">เปลี่ยนรหัสผ่านใหม่ <?php echo $row['prefix'].$row['firstname']. ' ' .$row['lastname'] ?></h1>
                                        </div>
                                        <form class="user" action="resetpassword_db.php" method="post">
                                        ...
                                        <?php } ?>
                                            <div class="form-group row">
                                                <div class="col-sm-4 ">
                                                    <h4 class="textcolor">รหัสผ่าน </h4>
                                                </div>
                                                <div>
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div>
                                                    <input type="password" class="form-control"
                                                        placeholder="ยืนยันรหัสผ่านใหม่" name="confirm_password"required>
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-success" name="changepassword">บันทึกข้อมูล</button>
                                        </form>
                                        <hr>
                                    </div>
                                </div>
