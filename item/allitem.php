...
$sql = "SELECT * FROM items WHERE status = 'ยังไม่ได้ใช้งาน'";
$stmt = $conn->query($sql);
$stmt->execute();
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">ตารางเบิกพัสดุ</h1>
                    <!-- DataTales Example -->
                                ...
                                <table class="display table table-bordered my-4" id="example" width="100%"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">จำนวนพัสดุที่มีการยืม</th>
                                            <th scope="col">จำนวนพัสดุทั้งหมด</th>
                                            <th class="col-md-1 text-center" scope="col">ยืมพัสดุ</th>
                                        </tr>
                                    </thead>
                                    <tbody id="table-body">

                                        <?php foreach ($data as $s): ?>
                                            <?php if (!empty($s['unititem']) && (intval($s['unititem']) === 0 || intval($s['units']) !== intval($s['unititem']))): ?>
                                                <tr>
                                                    <td scope="row">
                                                        <?php echo $num++; ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <?php echo $s['unititem'] - $s['units']; ?> <!-- คำนวณจำนวนคงเหลือ -->
                                                    </td>
                                                    <td>
                                                        <?php echo $s['units']; ?>
                                                    </td>
                                                    ...
                                                    <td><a href="submititem.php?id=<?php echo $s['id']; ?> ">ยืมพัสดุ</a>
