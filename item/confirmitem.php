...
$sql = "SELECT * FROM approve WHERE status = 'รออนุมัติการคืน'";
$stmt = $conn->query($sql);
$stmt->execute();
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">ตารางอนุมัติคืนพัสดุ</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                                    ...
                                    <table class="display table table-bordered my-4" id="example" width="100%"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="col-md-1" scope="col">อนุมัติการคืน</th>
                                            </tr>
                                        </thead>
                                        <tbody id="table-body">
                                            <?php foreach ($data as $s): ?>
                                                <tr>
                                                    ...
                                                    <td ><button type="button" class="btn btn-success btn-sm"
                                                            onclick="window.location.href='approveadmin1.php?id=<?php echo $s['id']; ?>'">
                                                            <a>อนุมัติการคืน</a>
                                                        </button>
                                                    </td>
                                                </tr>
                        ...
                        <button class="btn btn-primary "><a href="confirmitem1.php"
                                class="text-white">ดูรายชื่อรอรับพัสดุ</a></button>
                            <div class="my-4"></div>          
                        <!-- Logout Modal-->
