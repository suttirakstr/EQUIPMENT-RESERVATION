...
$statusArray = array("รอการอนุมัติ", "กำลังใช้งาน", "รออนุมัติการคืน", "รอการรับพัสดุ", "ยังไม่ได้ใช้งาน", "ไม่ได้รับการอนุมัติ");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">ประวัติการทำรายการ</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        ...
                        <button class="btn btn-primary "><a href="reitem.php"
                                class="text-white">ดูพัสดุที่ยืม</a></button>
                            <div class="my-4"></div>                     
