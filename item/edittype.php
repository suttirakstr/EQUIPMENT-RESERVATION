...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = $conn->prepare("UPDATE typei SET typename = :typename WHERE id = :id");
    $query->execute(array(':id' => $id, ':typename' => $typename));
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">ตารางประเภทพัสดุทั้งหมด</h1>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                name="typename" aria-describedby="typename"
                                                                                value="<?php echo $s['typename']; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <input type="hidden" name="id"
