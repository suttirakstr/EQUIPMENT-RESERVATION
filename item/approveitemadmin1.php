                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-5">คืนพัสดุ</h1>
                                        </div>
                                        <form class="user" action="" method="POST">
                                        <div class="form-group row">
                                            <label for="firstname" class="col-form-label">ชื่อผู้ใช้:</label>
                                                <div class="col-sm-6 ">
                                                    <input type="text" class="form-control" value="<?php echo $data['firstname']; ?>" aria-label="firstname" aria-describedby="iditem" name="firstname" readonly>
                                                </div>
                                                <div class="col-md-4 ">
                                                    <input type="text" class="form-control" value="<?= $data['lastname'] ?>" aria-label="iditem" aria-describedby="iditem" name="lastname" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            <label for="typeitem" class="col-form-label">ประเภทพัสดุ:</label>
                                                <div class="col-sm-5 ">
                                                    <input type="text" class="form-control" value="<?php echo $data['typeitem']; ?>" aria-label="typeitem" aria-describedby="typeitem" name="typeitem" readonly>
                                                </div>
                                            <label for="nameitem" class="col-form-label">ชื่อพัสดุ:</label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control col-md-12" value="<?= $data['nameitem'] ?>" aria-label="nameitem" aria-describedby="nameitem" name="nameitem" readonly>
                                                </div>
                                            </div>
                                               
                                            <div class="form-group row">
                                            <?php if ($role == 'user'): ?> <label for="nameitem" class="col-form-label">ชื่ออาจารย์ที่ปรึกษา:</label>
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" value="<?php echo $data['nameteacher']; ?>" aria-label="nameteacher" aria-describedby="nameteacher" name="nameteacher" readonly>
                                            </div><?php endif; ?>
                                            <label for="nameitem" class="col-form-label">จำนวนพัสดุ:</label>
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" value="<?= $data['units'] ?>" aria-label="units" aria-describedby="units" name="units" readonly>
                                            </div>
                                            </div>
